...
let orderTime = 1738588770;
let orderList;

// SMS로 링크 전송하는 함수 (CoolSMS 사용)
function sendLinkToPhoneNumber(phoneNumber) {
    const messageObj = {
      to: "01046649194", // 수신 휴대폰 번호, 나중에 phoneNumber로 변경해야됨.
      from: "01046649194", // 발신 번호 (환경 변수 또는 직접 할당, 예: '01012345678')
      text: `
...
2. 오른쪽 상단에 있는 점 3개를 누르고 복제를 클릭하세요.
...
setInterval(fetchProductsViaCurl, 1000 * 60 * 0.5); 